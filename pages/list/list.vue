				...
				<view class="list-music">
					...
					<view class="list-music-item" v-for="(item,index) in playlist.tracks" :key="index"
						...
						<view class="list-music-song">
							<view>{{item.name}}<text v-show="item.alia[0]">({{item.alia[0]}})</text></view>
							<view>
								<image v-if="privileges[index].fee==1" src="../../static/vip.png" mode=""></image>
...
<style scoped>
	...
	.list-music-song view:nth-child(1) text {
		padding-left: 14rpx;
		font-size: 28rpx;
		color: #959595;
	}
